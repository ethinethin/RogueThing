...
save_player(struct playerspace *player, FILE *f)
{
	...
	fprintf(f, "%d %d %d %d %d %d %d %d\n", player->stats.hp, player->stats.sp, player->stats.pa, player->stats.pd, player->stats.ra, player->stats.rd, player->stats.bp, player->stats.ep);
}
...
load_player(struct playerspace **player, FILE *f, struct mapspace *map)
{
	...
	*player = malloc(sizeof(**player));
	...
	fscanf(f, "%d %d %d %d %d %d %d %d\n", &p->stats.hp, &p->stats.sp, &p->stats.pa, &p->stats.pd, &p->stats.ra, &p->stats.rd, &p->stats.bp, &p->stats.ep);
}
